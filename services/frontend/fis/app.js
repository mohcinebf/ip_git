...
io.on('connection',socket =>{
    ...
    socket.emit('message',{type:'table',header:'Nächste Haltestellen',message:{ headers:"",items:[['13:00','Aachen hbf'],['13:15','Normaluhr'],['13:30','Kaiserplatz'],['13:45','Hansemannplatz'],['14:00','Bushof']]}})
